...
person.prototype={
    draw:function () {
        ...
        this.cobj.drawImage(this[this.status][this.state],0,0,272,340,0,0,this.width,this.height);
        this.cobj.restore();
    },
    update:function () {
        if(this.y>=this.h){
...
hider.prototype={
    draw:function () {
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.hider[this.state],0,0,400,400,0,0,this.width,this.height);
        this.cobj.restore();
    }
}
...
game.prototype={
    play:function (start,logo,end,logos) {
        ...
        start.css({display:"display",animation:"starts 2s ease forwards"});
